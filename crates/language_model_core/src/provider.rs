...
pub const WINDSURF_PROVIDER_ID: LanguageModelProviderId =
    LanguageModelProviderId::new("windsurf");
pub const WINDSURF_PROVIDER_NAME: LanguageModelProviderName =
    LanguageModelProviderName::new("Windsurf");

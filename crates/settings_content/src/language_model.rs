...
pub struct AllLanguageModelSettingsContent {
    ...
    pub windsurf: Option<WindsurfSettingsContent>,
}
...
#[with_fallible_options]
#[derive(Default, Clone, Debug, Serialize, Deserialize, PartialEq, JsonSchema, MergeFrom)]
pub struct WindsurfSettingsContent {
    /// The URL of the WindsurfAPI proxy server (e.g. http://localhost:3003/v1).
    pub api_url: Option<String>,
    pub available_models: Option<Vec<WindsurfAvailableModel>>,
}

#[with_fallible_options]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, JsonSchema, MergeFrom)]
pub struct WindsurfAvailableModel {
    /// The model name as used by the WindsurfAPI proxy (e.g. "claude-sonnet-4.6").
    pub name: String,

...
use crate::provider::{
    ...
    opencode::OpenCodeSettings, vercel_ai_gateway::VercelAiGatewaySettings, windsurf::WindsurfSettings, x_ai::XAiSettings,
};
...
impl settings::Settings for AllLanguageModelSettings {
    ...
    fn from_settings(content: &settings::SettingsContent) -> Self {
        ...
        let windsurf = language_models.windsurf.unwrap();
        ...
        Self {
            ...
            windsurf: WindsurfSettings {
                api_url: windsurf.api_url.unwrap(),
                available_models: windsurf.available_models.unwrap_or_default(),
            },
            x_ai: XAiSettings {
